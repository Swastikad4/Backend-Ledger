...
async function sendTransactionFailedEmail(userEmail, name, amount, toAccount){
  ...
  const html = `<p>Hello ${name},</p><p>Your transaction of $${amount} to account ${toAccount} has failed.</p><p>Please try again later.</p><p>Best regards,<br>The Backend Ledger Team</p>`;
